...
# Create a reproducibly corrupted copy of the Team 1 dataset by removing records, duplicating records, and introducing missing values, invalid data types, and negative volume values.
p=argparse.ArgumentParser(); p.add_argument('--input',default='data/clean/clean_market_data.csv'); 
p.add_argument('--output',default='data/messy/messy_market_data.csv'); a=p.parse_args()
...
# Save the corrupted DataFrame to a CSV file, creating the output directory if it does not exist.
